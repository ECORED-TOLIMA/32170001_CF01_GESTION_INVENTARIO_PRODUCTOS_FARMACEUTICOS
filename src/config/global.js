export default {
  ...
  menuPrincipal: {
    ...
    subMenu: [
      ...
      },
      {
        ...
        download: 'downloads/CFA_01_32170001_DU.pdf',
      },
      {
  ...
  referencias: [
    ...
    {
      referencia:
        'Ministerio de la Protección Social. (2007). Resolución 2955 de 2007: Por la cual se determina el Modelo de Gestión del Servicio Farmacéutico, se adopta el Manual de Condiciones Esenciales y Procedimientos y se dictan otras disposiciones.',
      link:
